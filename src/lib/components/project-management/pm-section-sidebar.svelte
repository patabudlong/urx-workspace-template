<script lang="ts">
	...
	import PmSettingsSectionMenu from '$lib/components/project-management/pm-settings-section-menu.svelte';
...
<aside class="border-border bg-muted/30 shrink-0 border-b" aria-label="Project Management navigation">
