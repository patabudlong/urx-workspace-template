...
<Dialog.Root bind:open>
	<Dialog.Content showCloseButton={false}>
		<Dialog.Header>
			...
			<Dialog.Description>
				This will delete {companyCount} companies, {contactCount} contacts, and {dealCount} deals that
				were loaded as sample data. Your own CRM records will not be affected.
			</Dialog.Description>
		</Dialog.Header>
