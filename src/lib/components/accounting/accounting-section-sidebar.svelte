...
<aside class="border-border bg-muted/30 shrink-0 border-b" aria-label="Accounting navigation">
	<div class="px-4 pt-4 pb-2">
		<h2 class="text-sm font-semibold">Accounting</h2>
		<p class="text-muted-foreground mt-1 text-sm leading-relaxed">
			General ledger, journals, and trial balance for this workspace.
		</p>
	</div>
