...
export function canManageProjectManagement(role: string | null | undefined): boolean {
	return role === WORKSPACE_MEMBER_ROLES.OWNER || role === WORKSPACE_MEMBER_ROLES.ADMIN;
}

export function canAccessProjectManagementWorkspace(role: string | null | undefined): boolean {
